...
The 45 surrogate PKs in the target schema are already declared
...
# CC-01 OK — 45 identity + 4 natural keys, all sequences ahead of data
```
...
49-table target schema is present.
